...
credentials = ServiceAccountCredentials.from_json_keyfile_name('/Users/dmcconologue/Documents/Python/WholeFoods-c3e3338a03d5.json', scope)
...
# code that deletes the current data
index = i+2
wks.insert_row(sale_list, index)
    
# loop for inserting data one row at a time 
i = 0
